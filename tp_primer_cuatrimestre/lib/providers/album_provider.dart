...
StateProvider<List<Album>> albumProvider = StateProvider((ref) => [
  Album(
    name:'Canciones del Huracán',
    artist:'Tan Biónica',
...
StateProvider<bool> actionAddProvider = StateProvider((ref) => false);

StateProvider<String> selectedAlbumProvider = StateProvider((ref) => '');